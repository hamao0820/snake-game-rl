...
class Dueling_Network(nn.Module):
    def __init__(self, n_frame, n_actions) -> None:
        ...
        self.conv1 = nn.Conv2d(n_frame, 32, 3, 1)
        self.pool1 = nn.MaxPool2d(2, 2)
        self.conv2 = nn.Conv2d(32, 64, 3, 1)
        self.attention_conv1 = nn.Conv2d(64, 64, 3, 1, 1)
        self.attention_conv2 = nn.Conv2d(64, 64, 3, 1, 1)
        self.conv3 = nn.Conv2d(64, 64, 3, 1)
        self.pool2 = nn.MaxPool2d(2, 2)
        self.act_fc = nn.Linear(20736, 512)
        self.act_fc2 = nn.Linear(512, n_actions)
        self.value_fc = nn.Linear(20736, 512)
    ...
    def forward(self, x):
        ...
        attention = self.relu(self.attention_conv1(x))
        attention = self.sigmoid(self.attention_conv2(attention))
        x = x * attention
